			...
			MainThreadManager.Run(() =>
			{
				switch (identity)
				{
					...
					case ExampleProximityPlayerNetworkObject.IDENTITY:
						...
						break;
					case NetGameManaegerNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new NetGameManaegerNetworkObject(networker, id, frame);
						break;
					...
					case TestNetworkObject.IDENTITY:
						...
						break;
					case NetTileNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new NetTileNetworkObject(networker, id, frame);
						break;
				}
